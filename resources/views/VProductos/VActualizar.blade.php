...
@section('content')
<div role="alert" id="mensajeProductoAct"
...
<div class="main row">
    <div class="col-12">
        ...
        <div id="errorAlertUpdate" class="alert alert-danger d-none" role="alert">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-8">
                        <div class="input-box">
                            ...
                            <input type="number" class="form-control" id="dias" name="dias" pattern="^\d+(\.\d{1,2})?$"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-8">
                        <label for="comision" class="darkblue-text-bold">Imagen</label>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <button class="btn-custom" type="submit">
                            actualizar
                            <span id="updateButtonSpinner" class="spinner-border spinner-border-sm d-none" role="status"
