...
<div class="main row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-5">
            <h3 class="mb-0">Planes de inversion</h3>
        </div>
        ...
        <div class="col-xl-12 col-md-12">
            <div class="badge-box-wrapper">
                <div class="row g-4 mb-4" id="product-cards">
...
<script src="{{ asset('js/usuario_inversion/listar.js') }}"></script>
...
<script>
    function redirect(id) {
        ...
        var url = "{{ route('seleccion_inversion_view', ['id' => ':id']) }}";
