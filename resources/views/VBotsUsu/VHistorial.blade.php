        ...
        <div class="col-xl-12 col-md-7">
            <div class="dashboard-box" style="background-color:#444746;">
                ...
                <div class="input-group mb-3 cutom__referal_input__group">
                    <input type="text" class="form-control" id="sponsorURL" placeholder="Digite la Fecha">
                </div>
            </div>
        </div>
...
<script type="module" src="{{ asset('js/usuario_bots/historial.js') }}"></script>
<script>
