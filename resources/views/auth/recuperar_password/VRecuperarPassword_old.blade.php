                        ...
                        <form id="resetPasswordForm">
                            <div class="row g-4">
                                ...
                                <div class="input-box col-12">
                                    <input type="password" name="clave" value="" class="form-control" id="usuClave"
                                        aria-describedby="emailHelp" placeholder="Escriba su contraseña" autocomplete="off">
                                </div>
                                <div class="input-box col-12">
                                    <input type="password" name="clave_confirmacion" value="" class="form-control"
                                        id="usuClave_confirmacion" placeholder="Confirmar contraseña" autocomplete="off">
                                </div>
                                <div class="col-12">
                                    <div class="links">
