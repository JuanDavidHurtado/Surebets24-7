        ...
        <section class="profile-setting">
            ...
            <div class="row">
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="upload-img" style="background-color:#444746;">
                        <form id="form_1">

                            <div class="img-box">
                                <input accept="image/*" name="imagen" type="file" id="imagen"
                                    onchange="previewImage()" />
                                <span class="select-file text-white">Elige imagen</span>
                                <img id="frame" src="{{ asset('darkpurple/img/perfil.png') }}"
                                    alt="preview user image" />
                            </div>

                            <h4 class="golden-text">
                                <span id="usu_doc"></span> <sup>
                                    <span id="usu_login"
                                        class="badge badge-pill bg-outline-success badge_lavel_style text-white border-1">
                                    </span>
                                </sup>
                            </h4>
                            <h5>
                                <p id="usu_cod" style="font-size: 0.9rem;"></p>
                            </h5>
                            <p id="fecha_union"></p>
                ...
                <div class="col-lg-8">
                    <div class="edit-area" style="background-color:#444746;">
                            ...
                            <form id="form_2">
                                <div class="row">
                                    <div class="col-md-4 mb-4 input-box">
                                        ...
                                        <input autocomplete="off" type="text" id="documento" name="documento"
                                            class="form-control" />
                                    </div>

                                    <div class="col-md-4 mb-4 input-box">
                                        <label for="firstname" class="golden-text">Nombres</label>
                                        <input autocomplete="off" type="text" class="form-control" name="nombre"
                                            id="nombre" />
                                    </div>

                                    <div class="col-md-4 mb-4 input-box">
                                        <label for="lastname" class="golden-text">Apellidos</label>
                                        <input autocomplete="off" type="text" id="apellido" name="apellido"
                                            class="form-control" />
                                    </div>
                                    ...
                                    <div class="col-12 mb-4 input-box">
                                        ...
                                        <textarea autocomplete="off" class="form-control" id="direccion"
                                            name="direccion" cols="30" rows="3"></textarea>
                                    </div>
                                </div>
                            ...
                            <form id="form_3">
                                <div class="row">
                                    <div class="col-md-6 mb-4 input-box">
                                        ...
                                        <input type="password" id="actual_clave" name="actual_clave" autocomplete="off"
                                    ...
                                    <div class="col-12 mb-4 input-box">
                                        <label for="password_confirmation" class="golden-text">Confirmar
                                            Contraseña</label>
                                        <input type="password" id="clave_conf" name="clave_conf" autocomplete="off"
                        ...
                        <div id="tab3" class="content ">
                            <div class="alert mb-0" style="background-color:#131314;">
