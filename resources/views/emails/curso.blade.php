...
<body>
    <pre style='text-align:left'>
        ...
        Has realizado la inscripción a un curso de aprendizaje en <strong style='color:#336EFF;'>Surebets 24/7</strong>. 
        Estamos emocionados de tenerte como parte de nuestra comunidad de aprendices.

        Tu solicitud de inscripción ha sido registrada y actualmente se encuentra en estado de revisión.

        Pronto recibirás una notificación vía correo electrónico con respecto al resultado de la revisión. 
        Estamos comprometidos en brindarte transparencia y excelencia en todo el proceso educativo.

        Gracias por elegir <strong style='color:#336EFF;'>Surebets 24/7</strong> para tu aprendizaje. Si tienes alguna pregunta o inquietud, 
        no dudes en contactarnos a través de la línea <strong style='color:#336EFF;'>+1 (929)867-3569</strong> o enviándonos un correo a 
