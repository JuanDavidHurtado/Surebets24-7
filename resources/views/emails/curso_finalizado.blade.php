...
<body>
    <pre style='text-align:left'>
        ...
        Tu inscripción al curso de aprendizaje <strong style='color:#336EFF;'>{{ $nom_curso }}</strong> en <strong style='color:#336EFF;'>Surebets 24/7</strong> ha sido aceptada.
        Estamos emocionados de darte la bienvenida a nuestra comunidad educativa.

        Ahora puedes comenzar tu aprendizaje y explorar los recursos disponibles para tu curso.
