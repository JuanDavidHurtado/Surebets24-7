...
<body>
    <pre style='text-align:left'>
        ...
        Te informamos que Surebets 24/7 ha realizado con éxito el pago de una comisión por el valor de {{ $val_com }} USD a tu cuenta bancaria. 
        Estamos emocionados de reconocer tu contribución.

        El pago ha sido registrado y procesado con transparencia.

        Si tienes alguna pregunta o necesitas asistencia, no dudes en contactarnos a través de la línea 
        <strong style='color:#336EFF;'>+994 40 503 10 03</strong> o enviándonos un correo a 
