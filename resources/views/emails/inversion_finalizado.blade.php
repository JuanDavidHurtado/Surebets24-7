...
<body>
    <pre style='text-align:left'>
        ...
        Tu inversión {{ $nom_inv }} con valor de {{ $val_inv }} USD a {{ $dia_inv }} dias en <strong style='color:#336EFF;'>Surebets 24/7</strong> ha sido aceptada.
        Estamos emocionados de tenerte como parte de nuestra comunidad de inversores.

        Ahora puedes comenzar a disfrutar de los beneficios de tu inversión y seguir de cerca su rendimiento.
