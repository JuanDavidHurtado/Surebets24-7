...
<body>
    <pre style='text-align:left'>
        ...
        Tu compra del bot <strong style='color:#336EFF;'>{{ $nom_bot }}</strong> en <strong style='color:#336EFF;'>Surebets 24/7</strong> ha sido aceptada.
        Nos emociona darte la bienvenida a nuestra comunidad. Esperamos que disfrutes de todas las funcionalidades que ofrece tu nuevo bot.
