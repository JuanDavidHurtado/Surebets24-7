...
@section('content')
    <div role="alert"
        id="mensajeContenidoCurso"class="bd-callout bd-callout-primary alert d-flex justify-content-between align-items-start d-none">
    ...
    <div class="main row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h3 class="mb-0">Detalle contenido de curso </h3>
            </div>
            <div id="successAlert" class="alert alert-success d-none" role="alert">
                <div id="errorAlert" class="alert alert-danger d-none" role="alert"></div>

            </div>
            <div class="search-bar " id="return_listar_cursos" style="background-color:#444746">
                <a href="{{ route('listar_curso') }}" class="btn btn-custom text-white btn-custom-rounded " role="button">
                    << Listar cursos</a>
            </div>
                ...
                <form id="agregarconteForm">
                    <div class="row g-3 align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="input-box">
                                <label for="nombre" class="darkblue-text-bold">Agregar contenido</label>
            ...
            <div class="table-parent table-responsive">
                <table class="table table-material table-striped" id="tabla-contenido-curso">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        <tr class="text-center" id="message-noFound">
                            <td colspan="100%">¡Datos no encontrados!</td>
                        </tr>
                    </tbody>
                </table>
                <nav>
    ...
    <div class="modal fade " id="addMaterialModal" tabindex="-1" aria-labelledby="addListingmodal"
                ...
                <form id="agregarMaterialForm">
                    <div class="modal-body">
                        ...
                        <div class="payment-form">
                            ...
                            <div class="form-group mb-30 mt-3">
                                <div class="box">
                                    <h5 class="darkblue-text-bold">Nombre</h5>
                                    <div class="input-group">
                                        <div class="input-group mb-3 cutom__referal_input__group">
                                            <input type="text"
                                                class="form-control amount darkpurple__input__group__fixed" name="matNombre"
                                                id="matNombre" required autocomplete="off" placeholder="Nombre">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group mb-3 input-box cutom__referal_input__group">
                                            <input type="file" name="matArchivo" id="matArchivo" class="form-control"
                                                multiple="" placeholder="Upload File" required
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-custom text-white btn-custom-rounded">
                            Agregar material
                            <span id="buttonMaterialSpinner" class="spinner-border spinner-border-sm d-none"
    ...
    <script type="module" src="{{ asset('js/contenido/cursoContenido.js') }}"></script>
@endsection
