...
<head>
    ...
    <meta name="description"
        content="Surebets es tu guía definitiva para apuestas deportivas. Descubre estrategias efectivas, consejos expertos y encuentra las mejores apuestas seguras para tus deportes favoritos.">
    <meta name="keywords"
        content="apuestas deportivas, estrategias de apuestas, consejos de apuestas, apuestas seguras, guía de apuestas, análisis de apuestas, pronósticos deportivos, estrategias de inversión en deportes">


    <link href="{{ asset('plantilla/images/favicon.png') }}" type="image/x-icon" rel="shortcut icon" />

    <link rel="apple-touch-icon" href="{{ asset('plantilla/images/favicon.png') }}">
    <title>{{$titulo}}</title>
    <link href="{{ asset('plantilla/images/favicon.png') }}" type="image/x-icon" rel="icon" type="image/png"
        sizes="16x16" />


    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
    <!-- Cambia al estilo que prefieras -->
    <meta name="apple-mobile-web-app-title" content="Surebets - Tu Guía de Apuestas Deportivas">


    <meta itemprop="name" content="Surebets - Tu Guía Definitiva para Apuestas Deportivas">
    <meta itemprop="description"
        content="Descubre las mejores estrategias y consejos para apuestas deportivas. Obtén asesoramiento experto y encuentra las mejores apuestas seguras para tus deportes favoritos.">
    <meta itemprop="image" content="">
    <meta name="csrf-token" content="{{ csrf_token() }}">


    <meta property="og:type" content="website">
    <meta property="og:title" content="Surebets - Tu Guía Definitiva para Apuestas Deportivas">
    <meta property="og:description"
        content="Descubre las mejores estrategias y consejos para apuestas deportivas. Obtén asesoramiento experto y encuentra las mejores apuestas seguras para tus deportes favoritos.">
    <meta property="og:image" content="">
    <meta property="og:image:type" content="image/png">
    <meta property="og:url" content="https://surebets24siete.com/">
    ...
    <style>
        /* Regla CSS con !important para aplicar un color de fondo a todos los inputs */
        input,
        textarea,
        select {
...
<body onload="preloder_function()" class="">
    <!-- bottom navbar -->
    <div class="bottom-nav fixed-bottom d-lg-none" style="background-color:#444746;">
        <div class="link-item">
        ...
        <div class="link-item" id="inversionA" style="display: none;">
            <a href="{{route('form_pendiente_inversion')}}">
                <span class="icon"><i class="fal fa-layer-group" aria-hidden="true"></i></span>
                <span class="text">Renta de Bots</span>
            </a>
        </div>
        ...
        <div class="link-item " id="cursoA" style="display: none;">
            <a href="{{route('form_pendiente_curso')}}">
    ...
    <div class="dashboard-wrapper">
        <!------ sidebar ------->
        <div id="sidebar" class="" style="background-color:#444746;">

            <div class="sidebar-top">
                <a class="navbar-brand d-none d-lg-block" href="{{ route('home_dashboard') }}"
                    style="display: flex; align-items: center; height: 50px;">
                    <h4 style="color: red; display: inline; font-weight: bold; margin: 0; line-height: 50px;">Surebet
                    </h4>
                    <h4 style="color: white; display: inline; font-weight: bold; margin: 0; line-height: 50px;">
                        s24/7.com</h4>
                </a>


                <!--a class="navbar-brand d-none d-lg-block" href="{{route('home_dashboard')}}"> <img src="" alt="brand logo"></a-->
                <div class="mobile-user-area d-lg-none">
                    <div class="thumb">
                        <!--img class="img-fluid user-img" src="" alt="..."-->
                        <a class="navbar-brand d-none d-lg-block" href="{{ route('home_dashboard') }}"
                            style="display: flex; align-items: center;">
                            <h4 style="color: red; display: inline; font-weight: bold; margin: 0;">Surebet</h4>
                            <h4 style="color: white; display: inline; font-weight: bold; margin: 0;">s24/7.com</h4>
                        </a>
                    </div>
                    <div class="content">
            ...
            <div class="level-wrapper">
                <div class="level-box" style="background-color:#444746;">
                    <h4 id="usuario"></h4>
                    <p id="nivel_usuario"></p>
            ...
            <ul class="main tabScroll">
                <li>
                    <a class="active" href="{{route('home_dashboard')}}"> <i class="fal fa-house"
                            aria-hidden="true"></i> Home
                    </a>
                </li>
                <li>
                    <a href="{{route('lista_inversion_finalizar')}}" class="sidebar-link">
                        <i class="fal fa-business-time" aria-hidden="true"></i> Renta de Bot Liquidar</a>
                </li>
                <li class="sidebar-item">
                    <a href="#submenuSaldo" data-toggle="collapse" class="sidebar-link collapsed">
                        <i class="fal fa-coins" aria-hidden="true"></i>
                        <span>Admin. Ficha</span>&nbsp
                        <i class="fal fa-angle-right" aria-hidden="true"></i>
                    </a>
                    <ul class="collapse list-unstyled" id="submenuSaldo">
                        <li>
                            <a href="{{route('girar_saldo')}}" class="sidebar-link">Transaccion</a>
                        </li>

                        <li>
                            <a href="{{route('historial_saldo')}}" class="sidebar-link">Historial</a>
                        </li>
                    </ul>
                </li>
                ...
                <div id="lista1" style="display: none;">
                    ...
                    <li>
                        <a href="{{route('historial_ad')}}"> <i class="fas fa-coins" aria-hidden="true"></i> Transaccion
                            Surebets
                        </a>
                    </li>
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuPendiente">
                            <li>
                                <a href="{{route('form_pendiente_inversion')}}" class="sidebar-link">Listar
                                    Renta de Bots</a>
                            </li>
                            <li>
                                <a href="{{route('form_pendiente_curso')}}" class="sidebar-link">Listar Curso</a>
                            </li>
                            <!--li>
                                <a href="{{route('form_pendiente_adelanto')}}" class="sidebar-link">Listar Adelanto</a>
                            </li-->
                            <li>
                                <a href="{{route('form_pendiente_bot')}}" class="sidebar-link">Listar Bot</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuComision">
                            <li>
                                <a href="{{route('lista_comision_finalizar')}}" class="sidebar-link">Comision
                                    Renta de Bots</a>
                            </li>

                            <li>
                                <a href="{{route('form_lista_comision_curso')}}" class="sidebar-link">Comision Curso</a>
                            </li>
                            <!--li>
                                <a href="{{route('lista_comision_arbol')}}" class="sidebar-link">Comision Arbol</a>
                            </li-->
                            <li>
                                <a href="{{route('form_lista_comision_bot')}}" class="sidebar-link">Comision Bot</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuPlan">
                            ...
                            <li>
                                <a href="{{route('form_agregar_producto')}}" class="sidebar-link">Agregar Producto</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuCursos">
                            ...
                            <li>
                                <a href="{{route('form_agregar_curso')}}" class="sidebar-link">Agregar Cursos</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div id="lista2" style="display: none;">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuTienda">
                            <li>
                                <a href="{{route('form_lista_inversion')}}" class="sidebar-link">Renta de Bots</a>
                            </li>
                            <li>
                                <a href="{{route('form_lista_curso')}}" class="sidebar-link">Curso</a>
                            </li>
                            <li>
                                <a href="{{route('form_lista_bots')}}" class="sidebar-link">Bots</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuHistorial">
                            <li>
                                <a href="{{route('historial_inversion')}}" class="sidebar-link">His. Renta de Bots</a>
                            </li>
                            <li>
                                <a href="{{route('historial_curso')}}" class="sidebar-link">His. Curso</a>
                            </li>
                            <li>
                                <a href="{{route('historial_bot')}}" class="sidebar-link">His. Bot</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul class="collapse list-unstyled" id="submenuReferido">
                            <li>
                                <a href="{{route('form_lista_referido')}}" class="sidebar-link">Listar referidos</a>
                            </li>
                            <li>
                                <a href="{{route('agregar_referido')}}" class="sidebar-link">Agregar referido</a>
                            </li>
                            <li>
                                <a href="{{route('ver_arbol')}}" class="sidebar-link">Mi arbol</a>
                            </li>
                        </ul>
                    </li>

                    <li class="sidebar-item">
                        <a href="#submenuBono" data-toggle="collapse" class="sidebar-link collapsed">
                            <i class="fal fa-money-bill" aria-hidden="true"></i>
                            <span>Bono Referencia</span>&nbsp
                            <i class="fal fa-angle-right" aria-hidden="true"></i>

                        </a>
                        <ul class="collapse list-unstyled" id="submenuBono">
                            <li>
                                <a href="{{route('form_lista_comision')}}" class="sidebar-link">Bono Renta de Bots</a>
                            </li>
                            <li>
                                <a href="{{route('lis_comi_cur')}}" class="sidebar-link">Bono Curso</a>
                            </li>
                            <!--li>
                                <a href="{{route('lista_comision_binario')}}" class="sidebar-link">Bono Binario</a>
                            </li-->
                            <li>
                                <a href="{{route('lista_comision_bot')}}" class="sidebar-link">Bono Bot</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <!-- content -->
        <div id="content" class="" style="background-color:#444746;">
            <div class="overlay" style="background-color:#131314;">
                <!-- navbar -->
                <nav class="navbar navbar-expand-lg" style="background-color:#444746;">
                    <div class="container-fluid">

                        <a class="d-lg-none" href="{{ route('home_dashboard') }}"
                            style="display: flex; align-items: center; height: 50px;">
                            <h4 style="color: red; display: inline; font-weight: bold; margin: 0; line-height: 50px;">
                                Surebet</h4>
                            <h4 style="color: white; display: inline; font-weight: bold; margin: 0; line-height: 50px;">
                                s24/7.com</h4>
                        </a>
                    ...
                    <div class="user-panel d-none d-lg-inline-block">
                        <span class="profile">
                            ...
                            <img id="perfil_img_default" src="{{ asset('darkpurple/img/userDefault.jpg') }}" alt="image"
                                style="display: none;" />
                            <img id="perfil_img" src="" alt="user img" class="img-fluid"></span>
                        <ul class="user-dropdown">
                            <li><a href="{{route('home_dashboard')}}"><i aria-hidden="true"
                                        class="fal fa-border-all"></i> dashboard
                                </a>
                            </li>
                            ...
                            <li><a id="logout"><i aria-hidden="true" class="fal fa-sign-out-alt"></i> Cerrar Sesion </a>
                            </li>
                        </ul>
                    </div>
                </nav>
                <!-- main -->
                <!--div class="container-fluid"-->
                <div class="container-fluid" style="background-color:#131314;">
        ...
        <!-- arrow up -->
        <a href="#" class="scroll-up" style="display: none;"><i class="fal fa-long-arrow-up" aria-hidden="true"></i>
        </a>


        <!-- Agrega el elemento de imagen para el spinner -->
        ...
        <script>
            ...
            if (containerElement) {
                // Si el elemento existe, inicializa y renderiza el gráfico
                var chart = new ApexCharts(containerElement, options);
                chart.render();
            }
        ...
        <svg id="SvgjsSvg1168" width="2" height="0" xmlns="http://www.w3.org/2000/svg" version="1.1"
