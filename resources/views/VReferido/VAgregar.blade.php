                    ...
                    <form id="agregarUserReferidoForm">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="input-box col-md-6">
                                <input type="text" name="usuDocumento" class="form-control" value="" placeholder="No Documento" required>
                            </div>
                         
                            <div class="input-box col-md-6">
                                <input type="text" name="usuLogin" class="form-control" value="" placeholder="Username" required>
                            </div>
                          
                            <div class="input-box col-md-6">
                                <input type="text" name="usuNombre" class="form-control" value="" placeholder="Nombre(s)" required>
                            </div>
                            <div class="input-box col-md-6">
                                <input type="text" name="usuApellido" class="form-control" value="" placeholder="Apellido(s)" required>
                            </div>
                            <div class="input-box col-md-6">
                                <input type="email" name="usuCorreo" class="form-control" value="" placeholder="Correo electronico" required>
                            </div>
                            ...
                            <div class="input-box col-md-6">
                                <input type="text" name="usuTelefono" class="form-control dialcode-set" value="" placeholder="Telefono" required>
                            </div>
                            <div class="input-box col-md-6">
                                <input type="text" name="usuDireccion" class="form-control dialcode-set" value="" placeholder="Direccion">
                            </div>
                            <div class="input-box col-md-6">
...
<script src="{{asset('js/referido.js')}}"></script>
