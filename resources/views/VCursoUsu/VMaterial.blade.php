...
@section('content')
    ...
    <div class="main row">
        <div class="col-12">
            ...
            <div class="row" style="background-color:#444746;">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch(`/api/seleccion_curso/${id}/${id_usu}`, {
                ...
                .then(data => {
                    ...
                    data.resultados.forEach((curso, index) => {
                        ...
                        const headerCell3 = document.createElement(
                            'th'); // Nuevo encabezado para "Contenido"
                        ...
                        curso.materiales.forEach((material, materialIndex) => {
                            ...
                            verMaterialButton.onclick = function() {
                                try {
                                    if (material.matTipoArchivo === ('application/pdf')) {
                                        ...
                                        var pdfUrl = "/" + material.matArchivo + '_' +
                                            material.idMaterial;
                                        ...
                                        videoPlayer.src = "/" + material.matArchivo + '_' +
                                            material.idMaterial;
                                    ...
                                    alert(console.error('Error al abrir el material:',
                                        error))
                                }
                            };
                            ...
                            row.appendChild(
                                cell3); // Agregar la nueva celda para el botón "Ver Material"
            ...
            function mostrarPDF(pdfUrl) {
                // Limpia el contenedor de PDF para evitar que se acumulen los anteriores
                ...
                loadingTask.promise.then(function(pdf) {
                    ...
                    function renderPage(pageNum) {
                        pdf.getPage(pageNum).then(function(page) {
                            ...
                            var scale = 2; // Aumentar la escala para mejorar la calidad
