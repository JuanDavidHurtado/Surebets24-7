document.addEventListener('DOMContentLoaded', function () {
    ...
    function fillTableWithData(data) {
        ...
        data.forEach((comision, index) => {
            ...
            row.innerHTML = `
                ...
                <td>${comision.concepto_nom + '<br>' + comision.concepto_cur} USD</td>
    ...
    fetch('/api/pendiente_comision_curso',
        {
            method: 'GET',
            headers: {
        ...
        .then(data => {
            if (data.length > 0) {
                ...
                noDataMessage.innerHTML = '<td colspan="7"><center>No hay comisiones pendientes por finalizar en este momento.</center></td>';
    ...
    filterStartDoc.addEventListener('input', function () {
        ...
        // Verifica si la tabla no está vacía antes de realizar la búsqueda
