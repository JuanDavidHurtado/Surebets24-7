    ...
    function fillTableWithData(data) {
        ...
        data.data.forEach((usu_cur, index) => {
            ...
            row.innerHTML = `
                ...
                <td>${usu_cur.botNombre + "<br>" + usu_cur.botValor} USD</td>
                <td>${usu_cur.usu_bot_estado}</td>
                <td> 
                <button class="badge bg-primary" onclick="actualizar('FINALIZADO', ${usu_cur.id_usu_bot})">Aceptar</button>
                <button class="badge bg-danger" onclick="actualizar('ANULADO', ${usu_cur.id_usu_bot})">Anular</button>
                </td>
            `;
    ...
    fetch('/api/pendiente_bot',
        ...
        .then(data => {
            ...
            if (data.data.length > 0) {
                ...
                noDataMessage.innerHTML = '<td colspan="7"><center>No hay solicitud de bots pendientes en este momento.</center></td>';
